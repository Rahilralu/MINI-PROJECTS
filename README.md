...
Logic to lock board during card checks

💡 This project helped me practice DOM manipulation, game state management, and visual effects using pure CSS and JavaScript.
